...
<div>
    ...
    <img id="preview" src="{{ $user->profile_picture }}" alt="profile_picture" class="w-24 h-24 rounded-md object-cover">
    <x-text-input id="profile_picture" name="profile_picture" type="file" class="mt-1 block w-full"
        :value="old('profile_picture', $user->profile_picture)" required autofocus autocomplete="profile_picture" />
